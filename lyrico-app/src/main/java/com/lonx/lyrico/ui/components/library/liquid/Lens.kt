// Adapted from Kyant0/AndroidLiquidGlass and the compose-miuix-ui example (Apache 2.0).
...
internal fun BackdropEffectScope.lens(
    ...
    runtimeShaderEffect(
        key = if (dispersionEnabled) "LyricoLiquidGlassLensDispersion" else "LyricoLiquidGlassLens",
        shaderString = if (dispersionEnabled) {
